...
public class PackagesController {
    ...
    public static Stage npstage;
    Stage newPackageStage;
   ...
   /*public void OnActionBtnNewPackage(ActionEvent event) throws SQLException {
    ...
    public void OnActionBtnNewPackage(ActionEvent event) throws SQLException {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../fxml/NewPackage.fxml"));
            Parent newpkgRoot = (Parent) fxmlLoader.load();
//            Stage agentStage = new Stage();
            newPackageStage = new Stage();
            newPackageStage.setTitle("Agents");
            newPackageStage.setScene(new Scene(newpkgRoot, 1000, 600));
            newPackageStage.initStyle(StageStyle.DECORATED);
            newPackageStage.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
        this.npstage = newPackageStage;
